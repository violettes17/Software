...
cv2.namedWindow("Game Boy Screen", cv2.WINDOW_NORMAL)        # Create window with freedom of dimensions
cv2.resizeWindow("Game Boy Screen", 1920, 1080) 
